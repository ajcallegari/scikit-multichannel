...
#     assert hasattr(palette[names[-1]],'predict') == True, "last pipe in pipeline must predict"
#     if hasattr(acc_metrics, '__iter__'):
...
def get_clone(pipe, disable_custom_cloning = False):
   ...
   disable_custom_cloning : bool
    ...
    Returns
    -------
    New transformer/estimator/predictor instance generated by the pipe.clone() method, if there is one. If not, the returned isntance is created by the generic sklearn.base.clone().
    or via the sklearn.base.clone: pipe.__class__(**pipe.get_params())
    Notes
    -----
...
class MultiInputPipeline:
    ...
    Returns
    -------
    new pipe instance generated by custom pipe.clone() method,
    or via the sklearn.base.clone: pipe.__class__(**pipe.get_params())
    """
